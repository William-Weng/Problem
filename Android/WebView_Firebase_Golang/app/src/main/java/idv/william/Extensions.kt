...
import idv.william.fcm_demo.WebViewFragment
...
class Extensions {
    ...
    object _AppCompatActivity {
         ...
         */
        fun AppCompatActivity._replaceFragment(@IdRes id: Int, fragment: Fragment?) {
            fragment?.let { supportFragmentManager.beginTransaction().replace(id, it).commit() }
        }
    }
