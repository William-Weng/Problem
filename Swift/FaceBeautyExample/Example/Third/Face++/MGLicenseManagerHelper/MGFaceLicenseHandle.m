...
+ (void)licenseKey:(NSString*)licenseKey licenseSecret: (NSString*)licenseSecret finish:(void(^)(bool License, NSDate *sdkDate))finish {
    
    // 检查 apk
    if ([licenseKey isEqualToString:@""] || [licenseSecret isEqualToString:@""]) {
